...
func TestValidateSignatureValues(t *testing.T) {
	...
	one := common.Big1
	zero := common.Big0
	secp256k1nMinus1 := new(big.Int).Sub(secp256k1.Secp256k1n, common.Big1)
	...
	check(false, 27, secp256k1.Secp256k1n, secp256k1nMinus1)
	check(false, 27, secp256k1nMinus1, secp256k1.Secp256k1n)
	check(false, 27, secp256k1.Secp256k1n, secp256k1.Secp256k1n)
