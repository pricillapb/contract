...
var (
	...
	ErrUintRange     = errors.New("hex number does not fit into 64 bits")
...
// DecodeUint decodes a hex string with 0x prefix as a quantity.
func DecodeUint(input string) (uint64, error) {
...
func MustDecodeUint(input string) uint64 {
...
func EncodeUint(i uint64) string {
	enc := make([]byte, 2, 10)
	copy(enc, "0x")
